        ...
        <div id="main" class='layout-navbar navbar-fixed'>
                ...
                <div class="row col-11 d-flex justify-content-between">
                    ...
                    <form action="{{ route('kelola.lagu') }}" method="get">
                        <div class="row g-3 align-items-center">
                            ...
                            <div class="col-auto">
                                <a class="btn btn-success" name="add" href="{{ route('lagu.add') }}"><i class="fa-solid fa-plus"></i> Add</a>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <x-datatable>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('lagu.edit',$item->slug) }}" class="btn btn-outline-warning"><i class="fa-solid fa-pen-fancy"></i> Ubah</a>
