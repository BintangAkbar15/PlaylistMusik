<x-layout>
    <div id="app">
        ...
        <div id="main" class='layout-navbar navbar-fixed'>
                ...
                <div class="row col-11 d-flex justify-content-between">
                    ...
                    <form action="{{ route('kelola.genre') }}" method="get">
                        <div class="row g-3 align-items-center">
                            ...
                            <div class="col-auto">
                                <a class="btn btn-success" name="add" href="{{ route('genre.add') }}"><i class="fa-solid fa-plus"></i> Add</a>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <x-datatable>
                <x-slot:title>Tabel Genre</x-slot:t>
                <x-slot:theader>
                    <tr>
                        <th>No</th>
                        <th>Name</th>
                ...
                <tr>
                    ...
                    <td>{{ $item->j_lagu }}</td>
                    <td>
                        <a href="{{ route('genre.edit',$item->slug) }}" class="btn btn-outline-warning"><i class="fa-solid fa-pen-fancy"></i> Ubah</a>
