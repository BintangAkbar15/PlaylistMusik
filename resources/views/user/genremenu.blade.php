        ...
        <div class="col-12 d-flex p-4 flex-column" style="background: rgb(104, 104, 104, 0.5); backdrop-filter: blur(20px); -webkit-backdrop-filter: blur(20px);">
            ...
            <div class="col-12 d-flex flex-column flex-md-row">
                        ...
                        @if ($loop->iteration % 2 == 1)
                            <a href="{{ route('user.genre',$item->slug) }}">
                                <div class="col-12 p-2 d-flex align-items-center m-2 gap-3 bg-dark rounded">
                                    <div style="width: 40px; height: 40px; background: {{ $item->color }}; font-size:20px; color:white" class="d-flex justify-content-center align-items-center">{{ $item->name[0] }}</div>
                ...
                <div class="col-6 p-2 d-none d-md-block">
                    @forelse ($new as $item)
                        ...
                        <a href="{{ route('user.genre',$item->slug) }}">
                            <div class="col-12 p-2 d-flex align-items-center m-2 gap-3 bg-dark rounded">
                                <div style="width: 40px; height: 40px; background: {{ $item->color }}; font-size:20px; color:white" class="d-flex justify-content-center align-items-center rounded">{{ $item->name[0] }}</div>
                                <label for="" class="fs-6">{{ $item->name }}</label>
                            </div>        
                        </a>        
                        @endif
            ...
            <div class="col-12 d-flex justify-content-evenly flex-wrap">
                @forelse ($artists as $item)
                    ...
                    <a href="{{ route('user.genre',$item->slug) }}" class="col-md-3 col-sm-6 p-2">
                        <div class="p-2 d-flex flex-column align-items-center gap-2"
                            ...
                            <div style="width: 140px; height: 140px; background: {{ $item->color }}; font-size:20px; color:white" class="d-flex justify-content-center align-items-center">{{ $item->name[0] }}</div>
