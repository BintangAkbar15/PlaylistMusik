<footer class="fixed-bottom  bg-dark col-12 d-flex pt-3" style="height: 15vh">
    <div class="col-8 col-md-3 d-flex align-items-center ps-4 gap-3" style="height:12vh;">
        <img src="{{ url('data\photo\michino thimoty kimochi.jpeg') }}" style="width: 70px; height: 70px;" class="rounded d-none d-md-block" alt="">
        <div class="d-flex flex-column gap-1 overflow-hidden">
            <label for="" class="fs-4 text-nowrap">Michino Timothy Kimino Kimochi</label>
            <label for="" class="fs-6 text-nowrap">Anne Happy</label>
        </div>
    </div>
